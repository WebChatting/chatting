...
insert into `group` (`name`, `owner_id`, `avatar_path`) values ('group002', 502, 'avatar/default_group_avatar.jpg');
-- 2. add user to group
...
insert into relation (`request_id`, `accept_id`, `type`, `status`) values (501, 102, 1, 1);
