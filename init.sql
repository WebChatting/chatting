...
-- init user
insert into user (`username`, `password`, `avatar_path`) values ('member001', '001', '/home/rekord/chatting/avatar/default_user_avatar.jpg');
insert into user (`username`, `password`, `avatar_path`) values ('member002', '002', '/home/rekord/chatting/avatar/default_user_avatar.jpg');
insert into user (`username`, `password`, `avatar_path`) values ('member003', '003', '/home/rekord/chatting/avatar/default_user_avatar.jpg');
insert into user (`username`, `password`, `avatar_path`) values ('member004', '004', '/home/rekord/chatting/avatar/default_user_avatar.jpg');
insert into user (`username`, `password`, `avatar_path`) values ('member005', '005', '/home/rekord/chatting/avatar/default_user_avatar.jpg');

-- init group
-- 1. create group (the group is a keyword)
insert into `group` (`group_name`, `avatar_path`) values ('group001', '/home/rekord/chatting/avatar/default_group_avatar.jpg');
-- 2. add user to group
